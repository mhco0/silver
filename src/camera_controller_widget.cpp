...
void CameraControllerWidget::Render() {
  ...
  ImGui::SliderFloat3("Normal", glm::value_ptr(camera_->normal_), 0.0f, 1.0f, "%.2f", ImGui::ImGuiSliderFlags);
  ImGui::SliderFloat3("Focus", glm::value_ptr(camera_->focus_), 0.0f, 1.0f, "%.2f");
  ImGui::SliderFloat3("Forward", glm::value_ptr(camera_->forward_), 0.0f, 1.0f, "%.2f");
